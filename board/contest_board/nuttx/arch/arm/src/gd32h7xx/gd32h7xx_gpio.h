/****************************************************************************
 * arch/arm/src/gd32h7xx/gd32h7xx_gpio.h
 *
...
#ifndef __ARCH_ARM_SRC_GD32H7_GD32H7XX_GPIO_H
#define __ARCH_ARM_SRC_GD32H7_GD32H7XX_GPIO_H
...
#if defined(CONFIG_GD32H7_GD32H7XX)
...
#define GPIO_CFG_SPEED_SHIFT           (12)                          /* Bits 12-13: GPIO speed */
#define GPIO_CFG_SPEED_MASK            (3 << GPIO_CFG_SPEED_SHIFT)
#  define GPIO_CFG_SPEED_12MHZ         (0 << GPIO_CFG_SPEED_SHIFT)   /* 12 MHz output speed */
#  define GPIO_CFG_SPEED_60MHZ         (1 << GPIO_CFG_SPEED_SHIFT)   /* 60 MHz output speed */
#  define GPIO_CFG_SPEED_85MHZ         (2 << GPIO_CFG_SPEED_SHIFT)   /* 85 MHz output speed */
#  define GPIO_CFG_SPEED_100_220MHZ    (3 << GPIO_CFG_SPEED_SHIFT)   /* 100/220 MHz output speed */
...
/* GD32H759 has NO GPIOI port (ports are A..H + J + K).
 * Encoding must skip I so that PORT_J maps to g_gpio_base[8]=GPIOJ
 * and PORT_K maps to g_gpio_base[9]=GPIOK. */
#  define GPIO_CFG_PORT_J          (8 << GPIO_CFG_PORT_SHIFT)    /*   GPIOJ */
#  define GPIO_CFG_PORT_K          (9 << GPIO_CFG_PORT_SHIFT)    /*   GPIOK */
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_GD32H7_GD32H7XX_GPIO_H */
